...
const en = {
  ...
  contribute: {
    ...
    fileShareHint: 'If you have files to share, you can send them via a file-sharing service and provide the link or reference in your message.',
    prepare: 'Send information',
    privacy: '',
    ready: 'Your information has been sent successfully.',
...
const sr: Messages = {
  ...
  contribute: {
    ...
    fileShareHint: 'Ako imate fajlove za deljenje, možete ih proslediti putem usluge za deljenje fajlova i navesti link ili referencu u poruci.',
    prepare: 'Pošaljite informacije',
    privacy: '',
    ready: 'Vaše informacije su uspešno poslate.',
